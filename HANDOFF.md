...
5. Следующий продуктовый пакет теперь логичнее брать уже как следующий UX-слой поверх существующей логики: либо сценарный вход на `/app`, либо более явный sequencing workflow для recovery/preparation, но не возврат к скрытому toolbox-style интерфейсу.
