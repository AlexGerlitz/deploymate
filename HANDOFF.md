...
5. Следующий продуктовый пакет теперь логичнее брать уже после review/handoff/export/preparation связки: либо более явный recovery sequencing workflow, либо другой safety boundary, но не ещё одну полировку restore/import-review экранов.
