...
5. Следующий продуктовый пакет теперь логичнее брать уже после review/handoff/export связки: следующий controlled preparation step или следующий recovery workflow boundary, но не ещё одну полировку restore/import-review экранов.
