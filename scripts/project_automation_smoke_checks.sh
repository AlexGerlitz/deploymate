...
/app|ops release readiness checklist|data-testid="ops-release-readiness-checklist"
/app|ops release deploy key checklist item|data-testid="ops-release-checklist-deploy-key"
/app|ops release repair playbook|data-testid="ops-release-repair-playbook"
/app|ops release repair key step|Restore the deploy public key
...
/app/deployment-workflow|deployment workflow title|data-testid="deployment-workflow-title"
/app/deployment-workflow|runtime deployments section|data-testid="runtime-deployments-section"
/app/deployment-workflow|runtime deployments title|data-testid="runtime-deployments-title"
...
/deployments/smoke-deployment|runtime detail main next step card|data-testid="runtime-detail-main-next-step-card"
/deployments/smoke-deployment|runtime detail main next step title|data-testid="runtime-detail-main-next-step-title"
/deployments/smoke-deployment|runtime detail main next step focus|data-testid="runtime-detail-main-next-step-focus"
/deployments/smoke-deployment|runtime detail redeploy review button|data-testid="runtime-detail-redeploy-review-button"
...
/deployments/smoke-deployment|runtime detail share order card|data-testid="runtime-detail-share-order-card"
/deployments/smoke-deployment|runtime detail share order title|data-testid="runtime-detail-share-order-title"
...
/deployments/smoke-deployment|runtime detail evidence order card|data-testid="runtime-detail-evidence-order-card"
/deployments/smoke-deployment|runtime detail evidence order title|data-testid="runtime-detail-evidence-order-title"
...
/deployments/smoke-deployment|runtime detail redeploy draft summary|data-testid="runtime-detail-redeploy-draft-summary"
...
/app/users|users recovery path button|data-testid="users-recovery-path-button"
/app/users|users main next step card|data-testid="users-main-next-step-card"
/app/users|users main next step title|data-testid="users-main-next-step-title"
/app/users|users main next step focus|data-testid="users-main-next-step-focus"
/app/users|users main next step copy|data-testid="users-main-next-step-copy"
/app/users|users main next step button|data-testid="users-main-next-step-button"
/app/users|users main next step copy button|data-testid="users-main-next-step-copy-button"
/app/users|users recovery path card|data-testid="users-recovery-path-card"
/app/users|users recovery path title|data-testid="users-recovery-path-title"
/app/users|users recovery path focus|data-testid="users-recovery-path-focus"
/app/users|users recovery path copy|data-testid="users-recovery-path-copy"
...
/app/server-review|server review create port input|data-testid="server-review-create-port"
/app/server-review|server review create username input|data-testid="server-review-create-username"
...
automation_smoke_templates_checks() {
  cat <<'EOF'
/app/deployment-workflow|templates card|data-testid="templates-card"
/app/deployment-workflow|templates section title|data-testid="templates-section-title"
/app/deployment-workflow|templates filter tabs|data-testid="templates-filter-tabs"
/app/deployment-workflow|templates filter all|data-testid="templates-filter-all"
/app/deployment-workflow|templates filter unused|data-testid="templates-filter-unused"
/app/deployment-workflow|templates filter recent|data-testid="templates-filter-recent"
/app/deployment-workflow|templates filter popular|data-testid="templates-filter-popular"
/app/deployment-workflow|templates search input|data-testid="templates-search-input"
/app/deployment-workflow|templates list|data-testid="templates-list"
/app/deployment-workflow|smoke template card|data-testid="template-card-smoke-template"
/app/deployment-workflow|template preview button|data-testid="template-preview-button-smoke-template"
/app/deployment-workflow|template deploy button|data-testid="template-deploy-button-smoke-template"
/app/deployment-workflow|template edit button|data-testid="template-edit-button-smoke-template"
/app/deployment-workflow|template duplicate button|data-testid="template-duplicate-button-smoke-template"
/app/deployment-workflow|template delete button|data-testid="template-delete-button-smoke-template"
/app/deployment-workflow|smoke template copy|Smoke template
