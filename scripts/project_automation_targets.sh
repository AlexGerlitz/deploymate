...
automation_classify_release_path() {
  ...
  case "$path" in
    ...
    backend/*)
      printf 'backend\n'
      ;;
    Makefile|README.md|RUNBOOK.md|HANDOFF.md|LICENSE|.gitignore|.github/*|scripts/project_automation_targets.sh|scripts/lib/project_automation_targets.sh|scripts/production_contract_gate.sh|scripts/release_workflow_audit.sh|scripts/release_maintenance_status.sh|scripts/sync_release_maintenance_status.sh|scripts/public_evidence_bundle.py|scripts/export_review_packet.py|scripts/deploy_key_recovery_packet.sh|scripts/verify_review_packet.py|scripts/check_latest_review_packet_artifact.py|scripts/public_review_gate.sh|scripts/release_audit_failure_classifier.js|scripts/release_audit_failure_classifier.test.js|scripts/release_audit_incident.js|scripts/release_audit_incident.test.js|scripts/release_audit_mode.js|scripts/release_audit_mode.test.js|scripts/release_incident_diagnostics.py|scripts/release_incident_diagnostics_test.py)
      printf 'docs\n'
      ;;
    *)
      printf 'shared\n'
