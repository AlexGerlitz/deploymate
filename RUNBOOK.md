...
26. keep fast smoke assertions inside `scripts/project_automation_smoke_checks.sh`, so the core auth/ops/runtime smoke runners stay reusable across projects
